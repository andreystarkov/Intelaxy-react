	...
	return (
		<div className="second-screen">
			...
			<div className="header gutter-10 row">
				...
				<div className="platform react col-md-2 col-md-offset-2 col-sm-2 col-sm-offset-1 active url" id="react" data-slide="1">

					<div className="empty-box"></div>

					<div className="logo"></div>

					<svg xmlns="http://www.w3.org/2000/svg" width="123" height="110" viewBox="0 0 123 110" className="react-anim">
				...
				<div className="platform rails col-md-2 col-sm-2 url" id="rails" data-slide="2">
				...
				<div className="platform ios col-md-2 col-sm-2" id="ios" data-slide="3">
				...
				<div className="platform android col-md-2 col-sm-2" id="android" data-slide="4">
				...
				<div className="body col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
					...
					<div className="carousel slider-nav">
						...
						<div className="platform react" id="react-text">
							...
							<p>
								React Native — то JS-фреймворк, основанный на JavaScript и React — JS-библиотеке для создания UI View-уровня. Данная технология позволяет делать нативные приложения для устройств на Android, iOS с отдельной адаптаций под каждую платформу, обеспечивает более дешевую и простую разработку и отличный пользовательский опыт.
							</p>
