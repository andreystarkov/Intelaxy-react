				...
				<div className="gutter-10 row">
					...
					{(viewPort === 'desktopHD' || viewPort === 'desktop' || viewPort === 'desktopSmall')
						...
						<div className="title col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
							...
							<p>
								Мы команда разработчиков на Ruby on Rails и React JS/Native. Создаем ERP, CRM, соц. сети, порталы и мобильные приложение. Любим кросс-платформенную разработку.
							</p>
